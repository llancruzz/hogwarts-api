"""
Django settings for hogwarts_api project.
...
WSGI_APPLICATION = "hogwarts_api.wsgi.application"
...
# environment the code will connect to the sqlite database here in Gitpod.
